...
describe Dessert do
  let(:chef) { double("chef", name: "Linda") }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["chocolate", "flour", "milk", "egg"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Linda the Great Baker")
      expect(dessert.serve).to eq("Chef Linda the Great Baker has made 100 brownies!")
    end
  end
